    ...
    public class ValidateEnterValue
    {
        ...
        public static CustomEnterValue EnterPhoneNumber()
        {
            ...
            while (true)
            {
                ...
                if (Regex.IsMatch(phoneNumber, ConstantInputs.PATTERN_PHONE_NUMBER))
                {
        ...
        public static CustomEnterValue EnterGender()
        {
            ...
            while (true)
            {
                ...
                if (gender.Equals(ConstantInputs.GENDER_FEMALE) || gender.Equals(ConstantInputs.GENDER_MALE))
                {
        ...
        {
            return invalidTimes == ConstantInputs.MAX_ENTER_INVALID_TIMES;
        }
    }
}