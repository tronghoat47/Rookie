...
namespace Assignment_1
{
    public class Commom
    {
        public static void Menu(List<Member> members)
        {
            ...
            while (true)
            {
                Console.WriteLine("-------------------Welcome to the Filter Member System--------------------\n\n" +
                    "0: Add a new Member\n" +
                ...
                choice = ValidateEnterValue.EnterInt();
                switch (choice)
                {
                    case 0:
                        {
                    ...
                    case 1:
                        {
                            ...
                            List<Member> memberByGender = WorkingWithList.GetListMembersByGender(members, gender);
                    ...
                    case 4:
                        {
                            ...
                            int year = ValidateEnterValue.EnterInt();
                            SubMenu(members, year);
                            break;
                        }
                    case 5:
                        {
        ...
        public static void SubMenu(List<Member> members, int year)
        {
            ...
            while (true)
            {
                Console.WriteLine($"1: Get list members has birth year is {year}\n" +
